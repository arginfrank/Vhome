        ...
        <div className={classes.paper} dir="rtl">     
          ...
          <form className={classes.form} noValidate>
              ...
              <Grid item xs={12} className={classes.num}>
                <p style={{color: 'white', textAlign: 'justify', padding: 15, fontSize: 'calc(18px + .5vw)', backgroundColor: '#2c2c2c', borderRadius: 10,}}>عکس گذرنامه، یک قطعه عکس 4×6 رنگی زمینه سفید، گواهی تمکن مالی به لاتین 35 میلیون تومان و بیمه مسافرتی خود را در زیر بارگذاری نمایید:</p>
